...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            this.attributes['playOrder'] = Array.apply(null, {length: showData.length}).map(Number.call, Number);
            ...
            sendPlainMessage.call(this, 
                'Welcome to the ESPN Radio UP. You can say, list shows to find a show and listen.',
                'Say list shows, to begin.'
            );
        },
        'PlayAudio' : function () {
        ...
        'GetShow' : function () {
            ...
            sendPlainMessage.call(this, 'STARTMODE: Requesting a show: ' + show);  
        },
        'GetList' : function () {
            // Initialize Attributes
            this.attributes['playOrder'] = Array.apply(null, {length: showData.length}).map(Number.call, Number);
        ...
        'GetRandom' : function () {
            ...
            sendPlainMessage.call(this, 'STARTMODE: Requesting a random show!!');
        },
        'AMAZON.HelpIntent' : function () {
            sendPlainMessage.call(this, 'Welcome to the ESPN Radio UP. You can say, list shows to find a show and listen.');
        },
        'AMAZON.StopIntent' : function () {
            sendPlainMessage.call(this, 'Good bye.');
        },
        ...
        'Unhandled' : function () {
            sendPlainMessage.call(this, 'Sorry, I could not understand. Please say, list shows, to begin.');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the ESPN Radio UP. You can say, list shows to find a show and listen.';
                reprompt = 'You can say, list shows, to begin.';
            } else {
                this.handler.state = constants.states.RESUME_DECISION_MODE;
                message = 'You were listening to ' + showData[this.attributes['playOrder'][this.attributes['index']]].title +
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            sendPlainMessage.call(this, 'You are listening to the ESPN Radio. You can say, Next or Previous to navigate through the playlist. ' + 'At any time, you can say Pause to pause the audio and Resume to resume.');
        },
        'SessionEndedRequest' : function () {
            // No session ended logic
        },
    ...
    resumeDecisionModeIntentHandlers : Alexa.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
        ...
        'LaunchRequest' : function () {
            sendPlainMessage.call(this, 
                'You were listening to ' + showData[this.attributes['playOrder'][this.attributes['index']]].title + ' Would you like to resume?',
        ...
        'AMAZON.HelpIntent' : function () {
            sendPlainMessage.call(this, 
                'You were listening to ' + showData[this.attributes['index']].title + ' Would you like to resume?', 
                'You can say yes to Resume or No to play from the top.'
            );
        },
        'AMAZON.StopIntent' : function () {
        ...
        'Unhandled' : function () {
            sendPlainMessage.call(this, 'Sorry, this is not a valid command. Please say help to hear what you can say.');
        }
    })
};
...
var controller = function () {
    return {
        play: function () {
            ...
            var show = showData[this.attributes['playOrder'][this.attributes['index']]];
            var offsetInMilliseconds = this.attributes['offsetInMilliseconds'];
            // Since play behavior is REPLACE_ALL, enqueuedToken attribute need to be set to null.
            this.attributes['enqueuedToken'] = null;

            if (canThrowCard.call(this)) {
                var cardTitle = 'Playing ' + show.headline;
                var cardContent = 'Playing ' + show.headline;
                this.response.cardRenderer(cardTitle, cardContent, null);
            }

            this.response.audioPlayerPlay(playBehavior, show.mp3Link, token, null, offsetInMilliseconds);
...
function shuffleOrder(callback) {
    ...
    var array = Array.apply(null, {length: showData.length}).map(Number.call, Number);
