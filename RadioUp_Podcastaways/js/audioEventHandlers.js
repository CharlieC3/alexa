...
var audioEventHandlers = Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
    ...
    'PlaybackNearlyFinished' : function () {
        ...
        if (enqueueIndex === showData.length) {
        ...
        var show = showData[this.attributes['playOrder'][enqueueIndex]];
        var expectedPreviousToken = this.attributes['token'];
        var offsetInMilliseconds = 0;
        
        this.response.audioPlayerPlay(playBehavior, show.mp3Link, enqueueToken, expectedPreviousToken, offsetInMilliseconds);
